      			...
      			<div class="col-lg-12 main-chart">
      				...
      				<table class="table table-striped">
      					<form action="fungsi/edit/edit.php?barang=edit" method="POST">
      						...
      						<tr>
      							<td>Satuan Barang</td>
      							<td><input type="text" class="form-control" value="<?php echo $hasil['satuan_barang'];?>" name="satuan_barang"></td>
      						</tr>
      						...
      						<tr>
      							<td></td>
      							<td><button class="btn btn-primary"><i class="fa fa-edit"></i> Update Data Barang</button></td>
      						</tr>
      					</form>
      				</table>
